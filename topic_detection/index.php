...
<div id="wrapper">
  ...
  <section class="callaction">
    	...
    	<div class="container">
      		<div class="row">
        		<center> <h1> News Topic Detection </h1> </center><hr />

            <!-- Project Info -Links to "Modal" Pop-Up below -->
            <div style="float:right; margin-top:-75px; margin-right:180px; width:10%">
                <a href="#" class="btn btn-info btn-rounded" data-toggle="modal" data-target="#myModal"><i class="fa fa-info"></i> </a> 
            </div>

          			<form method="POST" action="">
          			<div class="form-group">
            			<div align="center"><h4>Enter any new story here:</h4></div>
      		...
      		<div class="row">
        		<div class="form-group">
          			<h4><center>Here is the paragraph you entered:</center></h4>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>News topic detector works on a supervised machine learning approach namely Logistic Regression to predict the news topics of unseen news documents. This topic classifier has an accuracy of 71%. </p> 
            </div>
